...
namespace LcdAssets {
    ...
    const unsigned char noise[][1] = {{0x55}, {0x96}, {0x4b}, {0xac}, {0x52}, {0x4d}};
    const unsigned char roborallyRoundEmpty[] = {0x54, 0x54};
    const unsigned char roborallyRoundFilled[] = {0x57, 0x57};
